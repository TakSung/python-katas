...
def merge_katarc_patch(platform_name):
    """Merge platform-specific settings into .katarc.

    This function:
    1. Removes any existing platform settings from .katarc
    2. Appends new platform settings from .katarc.patch

    Args:
        platform_name (str): 'windows' or 'linux'

    Raises:
        FileNotFoundError: If .katarc or .katarc.patch is not found
    """
    katarc_path = Path(".katarc")
    patch_path = Path(f"platforms/{platform_name}/.katarc.patch")
    ...
    if not patch_path.exists():
        raise FileNotFoundError(
            ...
            f"Expected: platforms/{platform_name}/.katarc.patch"
        )

    print(f"📄 Updating .katarc with {platform_name} platform settings...")
...
This script will:
  ...
  4. Update .katarc with platform settings
        """
    )
    parser.add_argument(
        "platform",
    ...
    try:
        ...
        # Step 3: Merge platform settings
        merge_katarc_patch(platform_name)
        print()
        ...
        print("=" * 60)
        print()
        print(f"Your environment is now configured for {platform_name.upper()}.")
        print()
        print("Next steps:")
